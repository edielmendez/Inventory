...
<div class="container " ng-app="myApp" ng-controller="computadorasController">
 	<!--Formulario de nueva computadora-->
 	<form class="card-panel hoverable" ng-submit="createProduct()" name="computadoraForm" novalidate="">
 	<h5>Nuevo Registro de Computadora </h5>
 	...
 	<div class="row">
 		...
 		<div class="col s6" ng-class="{ 'has-error' : computadoraForm.fecha_de_compra.$invalid && !computadoraForm.fecha_de_compra.$pristine }">
 			...
 			<input required="" ng-model="fecha_de_compra" type="date"  id="form-fecha_de_compra"   name="fecha_de_compra" class="datepicker"/>
 	...
 	<div class="row">
 		<div class="col s3 offset-s3">
 			...
 			<button type="submit" class="waves-effect waves-light btn" ng-disabled="computadoraForm.$invalid">Crear</button>			
 		</div>
 		<div class="col s6 ">
